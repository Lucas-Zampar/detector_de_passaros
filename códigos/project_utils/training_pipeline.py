...
def parse_data(dataset_type='partial'):
    ...
    Parâmetros
    ----------
        dataset_type : especifica qual o tipo de dataset a ser carregado (partial para o conjunto parcial ou complete para o conjunto completo)
    ...
    if dataset_type == 'complete':
        images_dir = '../dataset/complete_dataset'
        annotations_dir = '../dataset/complete_dataset'
